...
// Package chequebook package wraps the 'chequebook' smart contract.
//
...
import (
	...
	"github.com/william/gee/contracts/chequebook/contract"
	"github.com/william/gee/core/types"
	"github.com/william/gee/crypto"
	"github.com/william/gee/log"
	"github.com/william/gee/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an gee transaction.
