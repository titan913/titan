...
type wizard struct {
	...
	services map[string][]string   // services known to be running on servers
...
// converts it to an gee address. If an empty line is entered, the default
// value is returned.
