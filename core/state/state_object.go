...
// stateObject represents an gee account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of william address of the account
	data     Account
	db       *StateDB
...
// Account is the gee consensus representation of accounts.
