...
// Package accounts implements high level gee account management.
package accounts
...
// Account represents an gee account located at a specific location defined
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain william.ChainStateReader)
