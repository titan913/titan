...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gee.ipc",
			endpoint:    "/data/testnet/gee.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gee.ipc",
			endpoint:    "/data/testnet/gee.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gee.ipc",
			endpoint:    "/data/testnet/gee.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gee.ipc",
			endpoint:    "/data/testnet/gee.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
