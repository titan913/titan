...
import (
	...
	"github.com/william/gee/crypto/sha3"
...
// ecrecover extracts the gee account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the gee address
...
// Author implements consensus.Engine, returning the gee address recovered
