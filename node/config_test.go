...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gee.ipc", false, filepath.Join(os.TempDir(), "gee.ipc")},
		{"data", "gee.ipc", false, "data/gee.ipc"},
		{"data", "./gee.ipc", false, "./gee.ipc"},
		{"data", "/gee.ipc", false, "/gee.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gee.ipc", true, `\\.\pipe\gee.ipc`},
		{"data", "gee.ipc", true, `\\.\pipe\gee.ipc`},
		{"data", `\\.\pipe\gee.ipc`, true, `\\.\pipe\gee.ipc`},
	}
