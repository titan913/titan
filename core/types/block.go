...
// Package types contains data types related to gee consensus.
package types
...
// Header represents a block header in the gee blockchain.
type Header struct {
...
// Block represents an entire block in the gee blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the gee RLP block format.
