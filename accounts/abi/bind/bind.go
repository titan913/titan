...
// Package bind generates gee contract Go bindings.
//
// Detailed usage document and tutorial available on the gee Wiki page:
// https://github.com/william/gee/wiki/Native-DApps:-Go-bindings-to-gee-contracts
package bind
