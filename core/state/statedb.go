...
// Package state provides a caching layer atop the gee state trie.
package state
...
// StateDBs within the william protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/william/gee/pull/16485#issuecomment-380438527),
