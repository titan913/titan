...
// setting up a new or managing an existing gee private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your gee private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new gee network down to  |")
	...
	log.Info("Administering gee network", "name", w.network)
